/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 70bdf6ec5dc8f46f1a864b04f0751d93)
// Runtime types generated with workerd@1.20260828.1 2026-03-02 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	CONVERSATION_ENCRYPTION_KEY_V1: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEEPSEEK_API_KEY" | "CLERK_SECRET_KEY" | "CLERK_WEBHOOK_SIGNING_SECRET" | "CONVERSATION_ENCRYPTION_KEY_V1">> {}
}
